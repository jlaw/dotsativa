...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "160x20", NULL };
...
static const char *tags[] = { "〡", "〢", "〣", "〤", "〥", "〦", "〧", "〨", "〩" };
...
static const Rule rules[] = {
	...
	{ "SmartGit", NULL,       NULL,           1 << 8,       0,           0,         0,        -1 },
...
static Key keys[] = {
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("change_backlight.py -inc") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("change_backlight.py -dec") },
